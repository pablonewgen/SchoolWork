 ...
 *  masc2188
 *  
 *  Assignment 2: Implement the OrderedListADT interface and create an OrderedArrayList.class.
 *  The class is not an array so elements will be accessed through methods inside of the class.
 *  Currently being used to implement a ordered array-based Priority Queue.
 **/
